...
class LoginFrame(wx.Frame):
    ...
    def login(self, event):
        ...
        try:
            ...
            print(123, 'serverAddress[0] ', serverAddress[0], serverAddress[1])
            con.open(serverAddress[0], port=int(serverAddress[1]))
            print(213)
            print(globals())
            ...
            if response == b'UserName Empty':
                ...
                self.Close()
                ChatFrame(None, 2, title='Chat Client   欢迎'+self.userName.GetLineText(0)+'用户', size=(500, 400))
                print("success")
        except Exception:
